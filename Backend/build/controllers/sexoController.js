...
class SexoController {
    ...
    list(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            let sexos = [];
            sexos = yield common.select("sp_sexo_list");
            res.json(sexos);
        });
    }
    selectById(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (validator.FormatoNumerico(id, 10) == false) {
                ...
                let sexos = [];
                sexos = yield common.selectById(id, "sp_departamento_select_by_id");
                res.json(sexos);
            }
        });
    }
    delete(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (validator.FormatoNumerico(id, 10) == false) {
                ...
                response = yield common.delete(id, "sp_sexo_delete");
...
exports.sexoController = new SexoController();
