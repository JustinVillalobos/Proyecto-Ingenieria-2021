...
exports.clasificadorController = void 0;
...
class ClasificadorController {
    ...
    list(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            let sexos = [];
            sexos = yield common.select("sp_clasificador_list");
            res.json(sexos);
        });
    }
    selectById(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (validator.FormatoNumerico(id, 10) == false) {
                ...
                let clasificadores = [];
                clasificadores = yield common.selectById(id, "sp_clasificador_select_by_id");
    ...
    delete(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (validator.FormatoNumerico(id, 10) == false) {
                ...
                response = yield common.delete(id, "sp_clasificador_delete");
...
exports.clasificadorController = new ClasificadorController();
